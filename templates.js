...
@media(max-width:560px){.cs-banner{height:160px}}`;
  ...
  function axRuntime() {
    ...
    document.addEventListener("click", function (ev) {
      ...
      if (im) { var it = im.getAttribute("title") || ""; modalOpen('<figure style="margin:0;background:#fbfbf9;border-radius:16px;padding:16px 16px 12px;box-shadow:0 24px 70px rgba(0,0,0,.55);max-width:min(1040px,92vw);max-height:88vh;display:flex;flex-direction:column;align-items:center"><img src="' + im.getAttribute("data-ax-img") + '" style="display:block;max-width:100%;max-height:78vh;width:auto;height:auto;object-fit:contain;border-radius:9px">' + (it ? '<figcaption class="axmono" style="text-align:center;font-size:12px;color:#5a5c63;margin-top:11px;max-width:100%">' + e(it) + '</figcaption>' : '') + '</figure>'); return; }
