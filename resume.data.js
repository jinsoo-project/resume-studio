...
window.RESUME = {
  ...
  companies: [
    ...
    },
    {
      ...
      works: [
        { id: "b-perf-dash", title: "전사·마케팅 성과 대시보드 & 데이터 자동화", category: "성과", featured: true, period: "2022.10–2024.12",
        ...
        { id: "b-selfserve", title: "Self-serve 매체 광고 운영·A/B·성과 효율화", category: "퍼포먼스", featured: false, period: "2022.10–2024.12",
          summary: "메타·구글 캠페인 기획·제작(DA 영상/이미지), 설치·전환 목적 숏폼 제작, CPI·인앱 이벤트 개선, 제작 템플릿화.",
          detail: "성과 테스팅 > 템플릿화로 소재 업데이트·제작 리소스 개선.", metrics: [], stack: ["Meta Ads", "Google Ads"], links: [], images: [] },
        { id: "b-attr", title: "어트리뷰션 툴 관리·최적화 (Amplitude·Airbridge)", category: "성과", featured: false, period: "2023.06–2024.12",
          summary: "이벤트 택소노미·QA, 주요 서비스·마케팅 데이터 퍼널 구축 및 성과 모니터링·분석 실행.",
          detail: "", metrics: [], stack: ["Amplitude", "Airbridge"], links: [], images: [] },
        { id: "b-wag", title: "와그 × 유니버설스튜디오재팬 제휴 캠페인", category: "제휴", featured: true, period: "2023.12–2024.12",
          summary: "크로스·업셀링 목적 제휴 캠페인 기획·페이지·소재 제작·운영, 선착순 티켓 목표 대비 조기 소진. 인플루언서 KOLs 협업.",
          detail: "숏폼 영상 2차 활용.", metrics: [], stack: [], links: [], images: [] },
        ...
        { id: "b-paid5", title: "월 5억 매체 예산 운영·통합 광고관리", category: "퍼포먼스", featured: true, period: "2021.12–2022.03",
          summary: "FBIG·Google Ads·Kakao Moment·NAVER GFA·Criteo·Apple Search Ads 통합 운영, 트래킹 툴 기반 매체별 효율 측정.",
          detail: "에어브릿지·앰플리튜드로 효율 측정.", metrics: [{ n: "5억", l: "월 최대 예산" }], stack: ["Airbridge", "Amplitude"], links: [], images: [] },
        { id: "b-content", title: "퍼포먼스 콘텐츠 기획·제작", category: "콘텐츠", featured: false, period: "2021.12–2022.03",
          summary: "설치·클릭 유도 퍼포먼스형 콘텐츠(이미지·카탈로그·영상) 제작으로 앱 트래픽 증가·예산 효율화.",
          detail: "", metrics: [], stack: [], links: [], images: [] },
        { id: "b-crm", title: "앱푸시 + 카카오 플친 온드매체 운영", category: "CRM", featured: false, period: "2021.12–2022.03",
          summary: "리타겟팅 목적 앱푸시·플친 운영, 신규/활성/비활성 유저별 메시지 차별화로 앱 유입 최대화.",
          detail: "", metrics: [], stack: [], links: [], images: [] },
        { id: "b-seo", title: "구글 SEO", category: "SEO", featured: false, period: "2022.02–2022.03",
          summary: "구글 트래픽 확보를 위한 앱 내 상품 키워드별 구글 노출 작업.",
          detail: "", metrics: [], stack: [], links: [], images: [] },
        { id: "b-babitalk-perf", title: "바비톡 퍼포먼스 콘텐츠·광고 운영", category: "콘텐츠", featured: true, period: "2019.06–2021.12",
          summary: "모델 '박나래' 활용 콘텐츠 A to Z(아이데이션·제작·집행·운영). 대리수술 안심존·부작용 위험성·1분닥터 인지 콘텐츠.",
          detail: "이미지·카탈로그·영상 다수, 애드저스트·앰플리튜드 효율 측정.",
          metrics: [], stack: ["Adjust", "Amplitude"],
          links: [{ label: "안심존 ver1", url: "https://youtu.be/itJn_03fUHg" }, { label: "안심존 ver2", url: "https://www.youtube.com/watch?v=V9QOrhaaTrw" }, { label: "부작용 위험성", url: "https://youtu.be/_l1UqZLJToc" }, { label: "1분닥터", url: "https://youtu.be/Sra_bglQYvo" }], images: [] },
        { id: "b-hada", title: "'바비톡하다' 브랜딩 캠페인", category: "브랜딩", featured: false, period: "2021.04–2021.12",
        ...
        { id: "b-purfly", title: "퍼플라이 기부런 캠페인", category: "브랜딩", featured: true, period: "2021.04–2021.12",
          summary: "굿즈 기획~판매 A to Z. 판매 3분 만에 1,000개 완판, 2,000만원 강동경희대병원 기부.",
          detail: "마라톤 굿즈 전액 암환우 기부. 모델 김민경 콘텐츠 촬영·제작·운영. 인지 확장·긍정 이미지 형성.",
        ...
        { id: "b-buzak", title: "부작용 알리기 캠페인", category: "브랜딩", featured: false, period: "2021",
          ...
          detail: "타 게시물 대비 높은 반응, 정보 공개로 서비스 신뢰도 효과.", metrics: [], stack: [], links: [{ label: "YouTube", url: "https://youtu.be/g1jv4YEiVyA" }], images: [] },
        { id: "b-teuga", title: "바비톡 특가 (커머스)", category: "커머스", featured: false, period: "2020.07–2021.06",
          ...
          detail: "", metrics: [{ n: "36회", l: "매주 완판" }], stack: [],
          links: [{ label: "상세", url: "https://babitalk.co.kr/post/hotdeal/21apr_1/index.html" }], images: [] },
        { id: "b-galvanic", title: "앱솔브랩 갈바닉 (신사업 커머스)", category: "커머스", featured: true, period: "2019.09–2020.05",
          summary: "뷰티기기 커머스 프로젝트, 네이버쇼핑 뷰티 핫딜 1위, 킥오프 8개월 만에 재고 소진. 티몬·위메프 특가 병행.",
          detail: "", metrics: [{ n: "1위", l: "네이버쇼핑 핫딜" }], stack: [],
        ...
        { id: "b-seburi", title: "뷰티 유튜브 채널 [쎄뷰리] 운영", category: "콘텐츠", featured: false, period: "2019.04–2019.10",
          ...
          detail: "인기 콘텐츠·상위 검색 키워드 위주 기획으로 리소스 투입 없이 자연유입 유지.", metrics: [{ n: "1,000", l: "구독자(6개월)" }], stack: [],
          links: [{ label: "YouTube 채널", url: "https://www.youtube.com/channel/UCudCgE-s22Q9HmNE9YQV_nw" }], images: [] },
        { id: "b-dating", title: "소개팅앱(당연시·스윗미·사랑애) 콘텐츠 제작", category: "콘텐츠", featured: false, period: "2019.04–2019.08",
          summary: "앱 트래픽 증가 목적 설치·클릭 유도 퍼포먼스형 콘텐츠(이미지·카탈로그·영상) 제작, 매체별 효율 측정.",
          detail: "", metrics: [], stack: ["Adjust", "Amplitude"], links: [], images: [] }
      ]
    },
    {
      id: "agency",
